...
RSpec.describe "Insurances API", type: :request do
  ...
  # Test suite for GET /v1/insurances
  describe "GET /v1/insurances" do
    before { get "/v1/insurances" }
  ...
  # Test suite for GET /v1/insurances/:id
  describe "GET /v1/insurances/:id" do
    before { get "/v1/insurances/#{insurance_id}" }

...
RSpec.describe "Occupations API", type: :request do
  ...
  # Test suite for GET /v1/occupations
  describe "GET /v1/occupations" do
    before { get "/v1/occupations" }
  ...
  # Test suite for GET /v1/occupations/:id
  describe "GET /v1/occupations/:id" do
    before { get "/v1/occupations/#{occupation_id}" }

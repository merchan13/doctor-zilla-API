...
RSpec.describe "PhysicalExams API", type: :request do
  ...
  # Test suite for GET /v1/physical_exams
  describe "GET /v1/physical_exams" do
    # make HTTP get request before each example
    before { get "/v1/physical_exams", params: { consultation: physical_exam.consultation.id } }
  ...
  describe "GET /v1/physical_exams/:id" do
    before { get "/v1/physical_exams/#{physical_exam_id}" }
  ...
  describe "PUT /v1/physical_exams/:id" do
    let(:valid_attributes) { { physical_exam: { observation: "Updated observation" } } }

    context "when the record exists" do
      before { put "/v1/physical_exams/#{physical_exam_id}", params: valid_attributes }

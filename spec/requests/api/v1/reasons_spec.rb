...
RSpec.describe "Reasons API", type: :request do
  ...
  # Test suite for GET /v1/reasons
  describe "GET /v1/reasons" do
    before { get "/v1/reasons" }
  ...
  # Test suite for GET /v1/reasons/:id
  describe "GET /v1/reasons/:id" do
    before { get "/v1/reasons/#{reason_id}" }

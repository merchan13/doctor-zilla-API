...
RSpec.describe "Medical Records API", type: :request do
  ...
  # Test suite for GET /v1/medical_records
  describe "GET /v1/medical_records" do
    # make HTTP get request before each example
    before { get "/v1/medical_records" }
  ...
  describe "GET /v1/medical_records/:id" do
    before { get "/v1/medical_records/#{medical_record_id}" }
  ...
  describe "PUT /v1/medical_records/:id" do
    let(:valid_attributes) { { medical_record: { name: "Dick", birthday: "1999/12/12" } } }

    context "when the record exists" do
      before { put "/v1/medical_records/#{medical_record_id}", params: valid_attributes }
  ...
  # Test suite for GET /v1/search_records
  describe "GET /v1/search_records" do
    before :each do
    ...
    context "when the search is successful" do
      before { get "/v1/search_records", params: { search_param: "Perez" } }
    ...
    context "when the search param doesn't match" do
      before { get "/v1/search_records", params: { search_param: "Zandra" } }
